...
export function PricingPage() {
  ...
  return (
    <PageWrapper>
      {/* Hero */}
      <section className="bg-[#0A0A0A] pt-32 pb-16 md:pt-40 md:pb-24 border-b border-[#2A2A2A]" ref={heroRef}>
        <div className="container-premium text-center" data-reveal>
          <h1 className="text-5xl md:text-6xl lg:text-7xl mb-6 leading-tight" style={{ fontFamily: "Syne, sans-serif", fontWeight: 800 }}>
            Honest pricing.<br />
            <span className="text-[#C9A84C]">No surprises.</span>
          </h1>
      ...
      <section className="section-padding bg-[#111111]" ref={pricingRef}>
        <div className="container-premium">
          ...
          <div className="flex justify-center mb-14" data-reveal>
            <div className="bg-[#0A0A0A] p-1.5 rounded-full inline-flex border border-[#2A2A2A] relative">
              <div 
                className="absolute top-1.5 bottom-1.5 rounded-full bg-[#1A1A1A] transition-all duration-300 ease-in-out border border-[#C9A84C]/30"
              ...
              <button 
                ...
                className={`relative z-10 px-6 py-2 text-sm font-medium transition-colors flex items-center gap-2 ${annual ? "text-[#C9A84C]" : "text-[#555555]"}`}
                style={{ fontFamily: "DM Sans, sans-serif" }}
              >
                Annually <span className="text-[10px] bg-[#C9A84C]/10 text-[#C9A84C] px-2 py-0.5 rounded-full border border-[#C9A84C]/20">SAVE 15%</span>
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* S7 */}
            <div className="bg-[#0A0A0A] border border-[#2A2A2A] rounded-2xl p-8 lg:p-10 flex flex-col" data-reveal>
              <div className="mb-8">
              ...
              <div className="mb-8 border-b border-[#2A2A2A] pb-8">
                ...
                <div className="text-5xl text-[#C9A84C] mb-4" style={{ fontFamily: "Syne, sans-serif", fontWeight: 800 }}>£199</div>
              ...
              <ul className="space-y-4 mb-10 flex-1">
                {["Real-time GPS tracking", "24/7 Secure Control Centre", "Geofencing & alerts", "Trip history", "App access", "UK-wide engineer installation", "Thatcham S7 certified"].map((item) => (
                  <li key={item} className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-[#C9A84C] shrink-0 mt-0.5" />
            ...
            {/* S5 */}
            <div className="bg-[#0A0A0A] border-2 border-[#C9A84C] rounded-2xl p-8 lg:p-10 relative flex flex-col shadow-[0_0_40px_rgba(201,168,76,0.1)]" data-reveal>
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-[#C9A84C] text-[#0A0A0A] text-xs font-bold py-1 px-4 rounded-full" style={{ fontFamily: "DM Sans, sans-serif" }}>
                RECOMMENDED
              </div>
              <div className="mb-8">
                <h2 className="text-3xl mb-2 text-[#C9A84C]" style={{ fontFamily: "Syne, sans-serif", fontWeight: 700 }}>S5 Premium</h2>
                <div className="text-[#999999] text-sm" style={{ fontFamily: "DM Sans, sans-serif" }}>Required by insurers for vehicles £50k+</div>
              </div>
              <div className="mb-8 border-b border-[#2A2A2A] pb-8">
                <div className="text-[#555555] text-xs uppercase tracking-widest mb-2 font-semibold">Hardware + Install</div>
                <div className="text-5xl text-[#C9A84C] mb-4" style={{ fontFamily: "Syne, sans-serif", fontWeight: 800 }}>£349</div>
      ...
      <section className="section-padding bg-[#0A0A0A]" ref={faqRef}>
        <div className="container-premium max-w-3xl">
          ...
          <div className="space-y-3" data-reveal>
            {faqs.map((faq, i) => (
              <div key={i} className="border border-[#2A2A2A] rounded-2xl overflow-hidden bg-[#111111]">
                <div className="p-6">
