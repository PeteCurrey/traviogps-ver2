      ...
      <section className="bg-[#0B0F19] pt-32 pb-16 md:pt-40 md:pb-24 border-b border-[#262D3D]">
        <div className="container-premium text-center">
          ...
          <h1 className="text-5xl md:text-6xl mb-6" style={{ fontFamily: "Syne, sans-serif", fontWeight: 800 }}>
            We're here to <span className="text-[#FF6B1A]">help.</span>
          </h1>
        ...
        <div className="container-premium max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8" data-reveal>
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-[#1E2533] flex items-center justify-center shrink-0">
                      <Phone className="w-5 h-5 text-[#FF6B1A]" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-[#1E2533] flex items-center justify-center shrink-0">
                      <Mail className="w-5 h-5 text-[#FF6B1A]" />
                    </div>
                    <div>
              ...
              <div className="p-6 bg-[#0B0F19] rounded-2xl border border-[#262D3D]">
            ...
            {/* Contact Form */}
            <div className="bg-[#0B0F19] p-8 rounded-3xl border border-[#262D3D]" data-reveal>
              <h2 className="text-2xl mb-6" style={{ fontFamily: "Syne, sans-serif", fontWeight: 700 }}>Send us a message</h2>
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-2 gap-4">
                  <input type="text" placeholder="First Name" className="w-full bg-[#111625] border border-[#262D3D] rounded-xl px-4 py-3 text-[#F5F5F5] focus:outline-none focus:border-[#FF6B1A]" />
                  <input type="text" placeholder="Last Name" className="w-full bg-[#111625] border border-[#262D3D] rounded-xl px-4 py-3 text-[#F5F5F5] focus:outline-none focus:border-[#FF6B1A]" />
                </div>
                <input type="email" placeholder="Email Address" className="w-full bg-[#111625] border border-[#262D3D] rounded-xl px-4 py-3 text-[#F5F5F5] focus:outline-none focus:border-[#FF6B1A]" />
                <select className="w-full bg-[#111625] border border-[#262D3D] rounded-xl px-4 py-3 text-[#999999] focus:outline-none focus:border-[#FF6B1A] appearance-none">
                  <option value="">Enquiry Type</option>
                  <option value="sales">Sales & Pricing</option>
                  <option value="support">Technical Support</option>
                  <option value="partners">Partnerships</option>
                </select>
                <textarea rows={4} placeholder="Your message..." className="w-full bg-[#111625] border border-[#262D3D] rounded-xl px-4 py-3 text-[#F5F5F5] focus:outline-none focus:border-[#FF6B1A]"></textarea>
