...
export default function LettingsPage() {
  const { properties: allProperties, isLoading } = useProperties("rent");
        ...
        <div className="container-premium">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-xl">
              Discover quality rental properties across the Peak District, Sheffield, 
              Chesterfield, and Nottingham. From city apartments to countryside homes.
            </p>
          </motion.div>
        </div>
      </section>
