...
import { ArrowRight, Shield, Users, Truck, Target, MapPin, Headphones, BarChart3, Zap } from "lucide-react";
    ...
    <PageWrapper>
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
        <div className="absolute inset-0">
          <img src={fleetHeroTracking} alt="Travio fleet tracking technology" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} viewport={{ once: true }} className="relative">
              <div className="aspect-[4/5] rounded-sm overflow-hidden">
                <img src={fleetManagerAbout} alt="Travio team at work" className="w-full h-full object-cover" />
              </div>
