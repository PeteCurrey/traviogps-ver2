        ...
        <div className="container-premium relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-5 bg-card/50 p-8 rounded-2xl border border-border/50">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="firstName">First Name *</Label>
                    <Input id="firstName" required value={form.firstName} onChange={(e) => setForm({ ...form, firstName: e.target.value })} className="bg-background" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="lastName">Last Name *</Label>
                    <Input id="lastName" required value={form.lastName} onChange={(e) => setForm({ ...form, lastName: e.target.value })} className="bg-background" />
                  </div>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="phone" type="tel" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} className="bg-background" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="company">Company Name</Label>
                  <Input id="company" value={form.companyName} onChange={(e) => setForm({ ...form, companyName: e.target.value })} className="bg-background" />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="message" rows={4} value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} placeholder="What are you looking for?" className="bg-background" />
                </div>
                <Button type="submit" size="lg" className="w-full bg-accent hover:bg-accent/90 text-accent-foreground font-semibold" disabled={loading}>
            ...
            >
              <div className="bg-card border border-border/50 rounded-2xl p-8 space-y-8 shadow-glow">
                <h3 className="font-bold text-xl text-foreground" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Why Choose Travio?</h3>
                <ul className="space-y-5 text-muted-foreground">
                  {[
                    "No long-term contracts — cancel anytime",
                    "Free professional installation available",
                    "Dedicated UK-based support team",
                    "Trusted by over 22,000 businesses",
                    "Average 15% reduction in fuel costs"
                  ].map((item, i) => (
                ...
                <div className="border-t border-border/50 pt-8 space-y-5">
                  <div className="flex items-center gap-4 text-sm text-foreground">
                    ...
                    <div>
                      ...
                      <p className="font-medium">0330 060 0499</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 text-sm text-foreground">
                    <div className="w-10 h-10 rounded-full bg-accent/10 flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium">info@travio.com</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 text-sm text-foreground">
                    <div className="w-10 h-10 rounded-full bg-accent/10 flex items-center justify-center">
