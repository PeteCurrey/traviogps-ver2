        ...
        <div className="container-premium">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {industries.map((industry, i) => (
              <motion.div
                key={industry.title}
                className="group p-8 rounded-2xl bg-card border border-border/50 hover:border-accent/30 transition-all duration-300 shadow-sm"
              ...
              >
                ...
                <h2 className="font-bold text-2xl text-foreground mb-4" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                  {industry.title}
                </h2>
                ...
                <Button asChild variant="ghost" className="text-accent hover:text-accent/80 p-0 h-auto group-hover:gap-3 transition-all font-semibold">
      ...
      <section className="section-padding bg-accent/5">
        <div className="container-premium text-center">
          ...
          <p className="text-muted-foreground mb-10 max-w-lg mx-auto text-lg leading-relaxed">
            Talk to our team and we'll recommend the right setup for your business requirements.
          </p>
