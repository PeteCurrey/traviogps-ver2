      ...
      <section className="relative pt-32 lg:pt-44 pb-20 overflow-hidden">
        ...
        <div className="container-premium relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="bg-card border border-border/50 rounded-2xl p-8 shadow-glow">
                <h3 className="font-bold text-xl text-foreground mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Schedule Your Free Session</h3>
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="message" rows={3} value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} placeholder="Tell us about your fleet requirements..." className="bg-background" />
                  </div>
                ...
                <p className="text-[10px] text-muted-foreground mt-4 text-center">
                  By clicking "Book My Free Demo", you agree to our Terms of Service and Privacy Policy.
                </p>
              </div>
            </motion.div>
          </div>
